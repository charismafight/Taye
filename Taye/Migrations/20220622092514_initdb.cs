        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ThumbnailFilePath = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Archives_AspNetUsers_AuthorId",
                        column: x => x.AuthorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "ea57c28f-a490-48cc-8c49-f18cb0db2ab0", "管理员", null },
                    { 2, "567d6128-c59a-4d0c-93f9-a06c70ec24f3", "用户", null }
                });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "Email", "EmailConfirmed", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { 1, 0, "a669cfe1-c400-4f84-a48f-72a34f70b836", "charismafight@hotmail.com", false, false, null, null, "admin", "AQAAAAEAACcQAAAAED4HSzRscFNJAo6vS2So0wbckj3ex221YhwEybpbE+3qzKVY7wB7tpEj0/3Y+k3heQ==", "17771819183", false, "b0081188-03d1-4765-a6d6-7c1013e314e0", false, "admin" });
